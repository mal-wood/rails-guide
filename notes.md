...
7) `rails g model model_name` (this will generate migration as well)...do this for all models<br> * make sure to use the singular version of the model name (it will automatically generate the plural version)
